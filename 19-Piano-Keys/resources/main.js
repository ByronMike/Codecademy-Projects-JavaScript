...
const keys = [
  ...
  /* Ne pas oublier le event en propriété de la fonction */
  ...
  function eventHandler(note) {
    /* la fonction devient un event handler, en rajoutant le 'on' */
  ...
  nextOne.onclick = function () {
    ...
    nextOne.hidden = true;
    /* On modifier le 5ème et 6ème accord*/
  ...
  nextTwo.onclick = function () {
    ...
    /* On rajoute un élément musical en plus */

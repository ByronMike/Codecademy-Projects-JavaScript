// Ce fichier JS enregistre la base de données
...
// "export default" est utilisé au lieu de "export" car on ne va pas réutiliser plusieurs fois ce module, il s'agit du module de données utilisé uniquement dans workAroundModule.js
